      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="#">Les plus récents arrivages</a>
              </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
        services: [{description:"I will find emails, list address, excel data entry, data mining, data scrapin", src: "https://fiverr-res.cloudinary.com/t_gig_cards_web,q_auto,f_auto/gigs/182814500/original/f6d530a179daa72caa0264f66a93030847100c9a.png", price: "STARTING AT US$50", rating: 5.0, count: 1020},
         ],
    }
  },
}
