...
import GigsSellerHeader from "./../components/GigsSellerHeader";
import GigsSellerCard from "./../components/GigsSellerCard";

export default {
  name: "MyComponent",
  components: { GigsInfo, GigsSellerHeader, GigsSellerCard },
  data() {
    return {
      loading: true,
      gigs: true,
  ...
  methods: {
    fetchData() {
      this.loading = true;
      fetchGigs(this.$route.params.slug)
        .then((res) => {
